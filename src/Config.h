...
#define WATER_LEVEL_PIN 21 // Water Level Sensor (Active Low)
...
#define MAX_PUMP_PERCENTAGE 100.0
#define FLOW_KP 3.0 // Gain: % to adjust pump per 1g/s of error. Tune this!
#define MAX_ADJUSTMENT 8.0 // Safety limit: max % the pump can jump in one tick

/////////////////////////////////////////////// TO REMOVE, also on GLOBAL.CPP
...
#define SPLASH_SCREEN_DELAY_MS 1000  // Splash screen minimum time
...
#define EMA_ALPHA_FLOW                                                         \
  0.15 // Exponential Moving Average smoothing factor for Flow rate measurement
